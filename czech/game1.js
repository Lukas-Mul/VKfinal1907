...
let questions = [
{
  question: "Zavedení všeobecného volebního práva znamená, že mohou volit všichni muži starší 24 let a do parlamentu mohou být zvoleni ve věku 30 let a výš. Končí také omezení volebního práva majetkem a původem. Souhlasíte s tímto nastavením?",
  choice1: "Ano",
  choice2: "Ne",
  answer: 1,
},
{
  question: "Část společnosti se domnívá, že by se volební právo mělo vztahovat i na ženy. Zastáváte tento názor?",
  choice1: "Ano",
  choice2: "Ne",
  answer: 2,
},
...
{
  question:
    "T. G. Masaryk, kandidát do parlamentu a profesor pražské univerzity, píše: „Důležitou součástí programu českých stran musí být zájem o Slovensko.“ <br>Sdílíte tento názor?",
  choice1: "Ano",
  choice2: "Ne",
  answer: 8,
},
...
},
{
  ...
  choice4:
    "„Jde nám o silnou politiku volné ruky, politiku ochotnou podporovat každou vládu, která k nám bude spravedlivá, <br>ale politiku odhodlanou potírati každou vládu, která nevyplňuje povinnosti státu k národu českému.“",
...
function firstPartyToSee(){
  if(allDivs[0].innerHTML.indexOf("KLERIKÁLNÍ STRANY") !== -1) {
    changingPartiesDiv.innerHTML = "<p>Klerikální strany</p><br><p>Klerikální neboli katolické strany vznikly ke konci 19. století. Dělily se na dva hlavní proudy: katolicko-národní a křesťansko-sociální.</p><br><p>Katolicko-národní strany se v roce 1897 spojily v Národní stranu katolickou <br>v Království českém. Národní strana katolická usilovala o mírovou spolupráci slovanských národů žijících na území habsburské monarchie, kterým <br>by nedominovaly německy mluvící elity. Zůstávala však loajální monarchii.</p><br><p>Křesťansko-sociální strana vznikla v roce 1894. Vyvíjela se spíše v občanské rovině.</p><br><p>Oba proudy byly ve své působnosti velmi konzervativní, odmítaly ženská hnutí <br>a společnost vnímaly jako stavovskou. V socialismu i liberalismu spatřovaly systémové zlo.</p>";
